...
<div class="page-content">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            {{--  Tagihan  --}}
            <div class="tab-pane fade show" id="pills-tagihan" role="tabpanel" aria-labelledby="pills-tagihan-tab">
                {{--  Desktop  --}}
                <div class="col-12 d-none d-sm-inline">
                    <div class="card-header" style="padding-top:0;">
                        <div class="card-body">
                            <table class="table table-bordered border-3" id="dataTable" width="100%" cellspacing="0">
                                ...
                                @forelse($dataTransaksi->where('transaction_status', 'TAGIHAN')->sortByDesc('updated_at') as $transaksi)
                                    <thead>
                                        <tr class="bg-second">
