...
<div class="page-content">
    <div class="container-fluid">
                ...
                <div class="card-header" style="padding-top:0;">
                    <div class="card-body">
                        <table class="table table-bordered border-3" id="dataTable" width="100%" cellspacing="0">
                            ...
                            @forelse($dataTransaksi->where('transaction_status', 'MENUNGGU KONFIRMASI')->sortByDesc('updated_at') as $transaksi)
                                <tbody>
                                    <tr class="bg-second">
            ...
            <div class="d-sm-none">
                ...
                @if($dataTransaksi->where('transaction_status', 'MENUNGGU KONFIRMASI')->count() != null)
                    <div class="row mt-3 mb-3">
                        <span class="fw-bolder text-center">Harap konfirmasi pesanan segera untuk menyiapkan pesanan</span>
                    </div>
                @endif
                @forelse($dataTransaksi->where('transaction_status', 'MENUNGGU KONFIRMASI')->sortByDesc('updated_at') as $transaksi)
        ...
        <!-- Modal Atur Konfirmasi Pesanan -->
        @foreach($dataTransaksi->where('transaction_status', 'MENUNGGU KONFIRMASI') as $transaksi)
