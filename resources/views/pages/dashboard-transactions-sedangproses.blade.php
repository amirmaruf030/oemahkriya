                                            ...
                                            @foreach($transaction->transaction_detail as $items)
                                                <tr>
                                                    <td>
                                                        ...
                                                        <br>
                                                        <span>{{ $items->qty }} pcs
                                                            <span class="float-right">Rp{{ number_format($items->price) }}</span>
                                                        </span>
                                                    </td>
                                                </tr>
                                            @endforeach
                                                <tr>
                                                    <td>
                                                        @if($transaction->payment_system == 'DP' && isset($transaction->tgl_byr_dp) && !isset($transaction->tgl_byr_tagihan))
                                                            <span class="float-right">Total Pesanan: Rp{{ number_format($transaction->total_price) }}
                                                            </span>
                                                            <br>
                                                            <span class="float-right">Tagihan Berikutnya: 
                                                                <span class="font-weight-bold">
                                                                    Rp{{ number_format($transaction->tagihan) }}
                                                                </span>
                                                            </span>
                                                        @else
                        ...
                        <div class="card-body" style="padding-bottom:0">
                            <table class="table table-borderless" id="dataTable" width="100%" cellspacing="0">
                                ...
                                <tbody>
                                    <tr>
                                        <td style="padding: 0;">
                                            <img src="{{ Storage::url($transaction->transaction_detail->first()->image ?? '') }}" alt="" style="width: 70px" class="img-thumbnail float-left mr-3">
                                        ...
                                        <td style="padding: 0;" class="d-flex flex-column">
                                            ...
                                            <div class="clearfix">
                                                ...
                                                @if($transaction->payment_system == 'DP' && isset($transaction->tgl_byr_dp) && !isset($transaction->tgl_byr_tagihan))
                                                    ...
                                                    <span class="float-right small text-muted">Tagihan Berikutnya: <span
