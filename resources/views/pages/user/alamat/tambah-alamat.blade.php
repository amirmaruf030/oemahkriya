                    ...
                    <div class="row mx-0">
                        <div class="col-12">
                            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                                <h1 class="h3 mb-0 text-gray-800">Tambah Alamat Baru</h1>
                            </div>
                            <form id="locations" action="{{ route('dashboard-proses-tambah-alamat') }}" method="POST">
                                @csrf
                                <div class="card">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="no_telp" class="form-control" name="no_telp" placeholder="No Telepon" />
                                                    @error('no_telp')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                </div>
            ...
            <div class="col-sm-12 d-sm-none" style="padding-left:0; padding-right:0;">
                <div class="card shadow">
                    <div class="row">
                        ...
                        <span class="font-weight-bold float-right mr-4">Tambah Alamat Baru</span>
                        </div>
                    </div>
                    <form id="locations" action="{{ route('dashboard-proses-tambah-alamat') }}" method="POST">
                    @csrf
